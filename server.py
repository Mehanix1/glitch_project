...
import views.jobs
from views.users_resource import UserResource, UserListResource
...
def main():
    ...
    api.add_resource(views.users_resource.UserListResource, '/api/v2/users')
    api.add_resource(views.users_resource.UserResource, '/api/v2/users/<int:news_id>')
